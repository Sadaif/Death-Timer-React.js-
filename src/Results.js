  ...
  renderTimes() {
    return (
      <div>
        ...
        <h2>On average you have {this.state.secondsLeft} seconds left in your life.  Make them count! </h2>
        <h2>You've spent {this.props.timeOnSite} of those seconds here.</h2>
      </div>
    )
  }
